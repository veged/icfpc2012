...
//
// ### function createNode ([parent], cmd)
...
//
Tree.prototype.createNode = function createNode(parent, cmd) {
    var node = new TreeNode(this, parent, cmd);
...
//
// ### function TreeNode (tree, parent, cmd)

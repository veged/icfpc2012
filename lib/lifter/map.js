...
Tile.prototype.bla = function bla () {};

Tile.prototype.setNeighbors = function setNeighbors () {
    if (!this.subtiles) return;
    if (!this.subtiles[0].subtiles) return;
};
